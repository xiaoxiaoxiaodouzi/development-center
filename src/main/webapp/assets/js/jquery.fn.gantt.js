        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                var ganttLeftPanel = $('<div class="leftPanel"/>')
                    .append($('<div class="row spacer"><div class="row name row1" style="background-color: #F9C4E1 !important;text-align:center">重要</div><div class="row name row1" style="background-color: #D8EDA3;text-align:center">一般</div><div class="row name row1" style="background-color: #FCD29A;text-align:center">可拖延</div> <p class="row name row2"></p><p class="row desc row2"></p><p class="row comp row2"></p> <div class="row name row0">名称</div><div  class="row desc row0">负责人</div><div class="row comp row0">完成度</div></div>')
                ...
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        ...
                        entries.push(
                            ...
                            '"title='+ entry.name+'  id="rowheader' + i +
