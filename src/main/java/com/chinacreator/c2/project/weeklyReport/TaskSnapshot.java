 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.c2.project.weeklyReport.TaskSnapshot", table = "c2_comunity_task_snapshot", ds = "")
public class TaskSnapshot implements Serializable {
	private static final long serialVersionUID = 1288476952133632L;
	...
	*/
	...
	/** 
	*/
	@Column(id = "cross_project", datatype = "boolean")
	private java.lang.Boolean crossProject;
	/** 
	*/
	...
	* 设置
	*/
	public void setCrossProject(java.lang.Boolean crossProject) {
	...
	* 获取
	*/
	public java.lang.Boolean isCrossProject() {
		return crossProject;
	}
