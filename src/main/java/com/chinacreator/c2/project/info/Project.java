 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.c2.project.info.Project", table = "zt_project",
    ds = "dev-center")
public class Project implements Serializable {
  private static final long serialVersionUID = 1299559475838976L;
  /**
   *id
   */
   ...
   *合同编号
   */
  @Column(id = "contract_no", datatype = "string64")
